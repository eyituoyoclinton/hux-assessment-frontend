...
export default (props: DataState) => {
   const { updateContact } = useUserFunction()
   const [comState, setComState] = useState<{ data: any }>({ data: { firstname: props?.data?.firstname, phoneNumber: props?.data?.mobile, lastname: props?.data?.lastname } })
   console.log(props)
                     ...
                     <form method="post">
                        <div className="containerForm">
                           <div className='row'>
                              <div className='col-12 mb-2'>
                                 <div className="w-100 mb-2">
                                    <p>Firstname</p>
                                    <input className='my-form-control' defaultValue={props?.data?.firstname} type="text" placeholder="e.g: Name of user" onChange={(e) => {
                              ...
                              <div className='col-12 mb-2'>
                                 <div className="w-100 mb-2">
                                    <p>lastname</p>
                                    <input className='my-form-control' defaultValue={props?.data?.lastname} type="text" placeholder="e.g: Name of user" onChange={(e) => {
                              ...
                              <div className='col-6 mb-2'>
                                 <div className="w-100 mb-2">
                                    <p>Phone of user</p>
                                    <input className='my-form-control' defaultValue={props?.data?.mobile} type="tel" placeholder="e.g: 23470619xxxx" onChange={(e) => {
                           ...
                           <button className="loginBtn mt-4" type="button" onClick={(e) => {
                              e.preventDefault()
                              updateContact(comState?.data, props?.onPress, props?.data?.contact_id)
